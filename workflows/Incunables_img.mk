...
CROP = OCR-D-SEG-CROP-anybaseocr
...
$(RECOG): PARAMS = "textequiv_level": "glyph", "overwrite_segments": true, "model": "LatinInc_4.182000_25880_39700", "padding": 10, "oem": "DEFAULT"

OUTPUT = OCR-D-EXTGLYPHS-tesseract

$(OUTPUT): $(RECOG)
$(OUTPUT): TOOL = ocrd-segment-extract-glyphs
$(OUTPUT): PARAMS = "feature_filter": "binarized,normalized,grayscale_normalized,despeckled", "to_binary": false, "in_memory": false, "transparency": true
