...
$(SEG): PARAMS = "shrink_polygons": true, "find_tables": false, "padding": 30

RECOG = OCR-D-RECOG-tesseract

$(RECOG): $(SEG)
$(RECOG): TOOL = ocrd-tesserocr-recognize
$(RECOG): PARAMS = "textequiv_level": "glyph", "overwrite_segments": true, "model": "Latin", "padding": 30, "oem": "DEFAULT"
